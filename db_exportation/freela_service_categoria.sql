...
--
-- Table structure for table `service_categoria`
--

DROP TABLE IF EXISTS `service_categoria`;
...
CREATE TABLE `service_categoria` (
  ...
  CONSTRAINT `service_categoria_ibfk_1` FOREIGN KEY (`ID_Service`) REFERENCES `service` (`ID_Service`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `service_categoria_ibfk_2` FOREIGN KEY (`ID_Categoria`) REFERENCES `categoria` (`ID_Categoria`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `service_categoria`
--
