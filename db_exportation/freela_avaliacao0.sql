...
CREATE TABLE `avaliacao` (
  ...
  UNIQUE KEY `uc_avaliacao_unica` (`ID_Cliente`),
  KEY `ID_Freelancer` (`ID_Freelancer`),
  CONSTRAINT `avaliacao_ibfk_1` FOREIGN KEY (`ID_Cliente`) REFERENCES `usuario` (`ID_User`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `avaliacao_ibfk_2` FOREIGN KEY (`ID_Freelancer`) REFERENCES `usuario` (`ID_User`) ON DELETE SET NULL ON UPDATE CASCADE,
